...
describe VouchersController do
  ...
  describe "GET #index" do
    it 'populate an array of all vouchers' do
  ...
  describe "POST #create" do
    context "with valid attributes" do
      ...
      it "redirects to vourchers#show" do
        post :create, params: { voucher: attributes_for(:voucher) }
  ...
  describe "PATCH #update" do
    ...
    context 'with valid attributes' do
      ...
      it "change @voucher attributes" do
        patch :update, params: { id: @voucher, voucher: attributes_for(:voucher, code: 'PROMO') }
        @voucher.reload
    ...
    context 'with invalid' do
        ...
        patch :update, params: { id: @voucher, voucher: attributes_for(:voucher, code: 'PROMO', amount: nil) }
        @voucher.reload
        expect(@voucher.code).not_to eq('PROMO')
      end
